...
crown_class_name="SNBQ4Job"
input_file="${SCRIPT_PATH}/crown_data/crown_snb_${SCALE_FACTOR}/snb4_window/data.csv"
...
echo "RUNNING SNB4 - core :${executor_cores} - parallelism ${parallelism} - SF ${SCALE_FACTOR}"
