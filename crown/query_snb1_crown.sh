...
crown_class_name="SNBQ1Job"
input_file="${SCRIPT_PATH}/crown_data/crown_snb_${SCALE_FACTOR}/snb1_window/data.csv"
...
echo "RUNNING SNB1 - core :${executor_cores} - parallelism ${parallelism} - SF ${SCALE_FACTOR}"
