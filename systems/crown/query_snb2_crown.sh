...
crown_class_name="SNBQ2Job"
input_file="${SCRIPT_PATH}/crown_data/crown_snb_${SCALE_FACTOR}/snb2_window/data.csv"
...
echo "RUNNING SNB2 - core :${executor_cores} - parallelism ${parallelism} - SF ${SCALE_FACTOR}"
