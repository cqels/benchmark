create stream message (
    ...
    m_c_replyof varchar
) FROM FILE '/root/benchmark/dbtoaster/dbtoaster_data/snb_0_3/ouput/dbtoaster.message.window.csv'
...
create stream knows1 (
   ...
   k_personid1 varchar,
   k_personid2 varchar
) FROM FILE '/root/benchmark/dbtoaster/dbtoaster_data/snb_0_3/ouput/dbtoaster.knows1.window.csv'
LINE DELIMITED CSV (delimiter := '|');
...
create stream knows2 (
   ...
   k_personid1 varchar,
   k_personid2 varchar
) FROM FILE '/root/benchmark/dbtoaster/dbtoaster_data/snb_0_3/ouput/dbtoaster.knows2.window.csv'
LINE DELIMITED CSV (delimiter := '|');
...
) FROM FILE '/root/benchmark/dbtoaster/dbtoaster_data/snb_0_3/ouput/dbtoaster.tag.window.csv'
LINE DELIMITED CSV (delimiter := '|');
...
create stream message_tag (
   ...
   mt_tagid varchar
) FROM FILE '/root/benchmark/dbtoaster/dbtoaster_data/snb_0_3/ouput/dbtoaster.messagetag.window.csv'
LINE DELIMITED CSV (delimiter := '|');
