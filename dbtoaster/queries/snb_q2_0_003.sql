...
create stream knows1 (
   ...
   k_personid1 varchar,
   k_personid2 varchar
) FROM FILE '/root/benchmark/data_tool/ldbc_snb/snb/snb_0_003/knows1'
LINE DELIMITED CSV (delimiter := '|');
...
create stream knows2 (
   ...
   k_personid1 varchar,
   k_personid2 varchar
) FROM FILE '/root/benchmark/data_tool/ldbc_snb/snb/snb_0_003/knows2'
LINE DELIMITED CSV (delimiter := '|');
...
) FROM FILE '/root/benchmark/data_tool/ldbc_snb/snb/snb_0_003/tag'
LINE DELIMITED CSV (delimiter := '|');
...
create stream message_tag (
   ...
   mt_tagid varchar
) FROM FILE '/root/benchmark/data_tool/ldbc_snb/snb/snb_0_003/message_tag'
LINE DELIMITED CSV (delimiter := '|');
