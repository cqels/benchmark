...
object Rsnb_q1_0_003 {
  import Helper._

  

  def execute(args: Array[String], f: List[Any] => Unit) = 
    bench(args, (dataset: String, parallelMode: Int, timeout: Long, batchSize: Int) => run[Rsnb_q1_0_003](
      Seq(
        ...
        (new java.io.FileInputStream("/root/benchmark/data_tool/ldbc_snb/snb/snb_0_003/person"),new Adaptor.CSV("PERSON","string,string,string,string,string,string,string,string,string,string,string,string,string","\\Q|\\E", "insert"),Split()),
        (new java.io.FileInputStream("/root/benchmark/data_tool/ldbc_snb/snb/snb_0_003/knows"),new Adaptor.CSV("KNOWS","string,string,string,string,string","\\Q|\\E", "insert"),Split())
      ), 
...
class Rsnb_q1_0_003Base {
  import Rsnb_q1_0_003._
...
class Rsnb_q1_0_003 extends Rsnb_q1_0_003Base with Actor {
